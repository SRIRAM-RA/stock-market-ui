$(document).ready(function() {
  ...
  let data = {
    dataValues: [[10,10,10],[3,2,1], [4,3,2], [5,4,3], [6,5,4],[7,6,5],[8,7,6]], // for a normal bar chart use multiple arrays with 1 value in each array
    legend: ["Total Interest: <b>K 244,313</b>", "Employee:<b>K 52,500</b>", "Employer:<b> K 73,500</b>"], // for stacked bar charts
    legendColors: ["#5CB3FF", "#2554C7", "#000080"], // bar colors
    barLabels: ["20", "25", "30", "35","40","60","65"], // x-axis labels
    labelColors: [] // x-axis label colors
  };
  ...
  function drawYAxis(data) {
    ...
    //   }
    // }
    $(".yAxis").append("<div class='yAxisLabel'>$300</div>");
    $(".yAxis").append("<div class='yAxisLabel'>$200</div>");
    $(".yAxis").append("<div class='yAxisLabel'>$100</div>");
    $(".yAxis").append("<div class='yAxisLabel'>$0</div>");
  }
